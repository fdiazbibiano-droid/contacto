"use strict";(self.webpackChunknwpoint_cms=self.webpackChunknwpoint_cms||[]).push([[720],{40216(dt,S,s){s.d(S,{S:()=>N});var t=s(92132),_=s(47610),P=s(94061),G=s(48653),F=s(83997),X=s(30893);const w=(0,_.Ay)(P.a)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
