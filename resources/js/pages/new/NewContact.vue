                ...
                <ul class="info-list">
                    <li>
                        <div class="info-icon">
                            <svg viewBox="0 0 24 24" fill="none">
                                <path
                                    d="M6.62 10.79a15.05 15.05 0 006.59 6.59l2.2-2.2a1 1 0 011.01-.24c1.12.37 2.32.57 3.58.57a1 1 0 011 1V20a1 1 0 01-1 1C10.18 21 3 13.82 3 5a1 1 0 011-1h3.5a1 1 0 011 1c0 1.26.2 2.46.57 3.58a1 1 0 01-.25 1.01l-2.2 2.2z"
                                    stroke="white"
                                    stroke-width="1.8"
                    ...
                    <li>
                        ...
                        <div>
                            ...
                            <a href="mailto:info@nwpointconstruction.com"
                                >info@nwpointconstruction.com</a
                            >
                        </div>
                    </li>
                    <li>
                ...
                <form v-else @submit.prevent="submitForm" class="form">
                    ...
                    <div class="form-group">
                        ...
                        <select v-model="form.service">
                            ...
                            <option
                                v-for="svc in t.contact.services"
                                :key="svc"
                                :value="svc"
                            >
                                {{ svc }}
...
const submitForm = async () => {
    ...
    try {
        // Enviar los datos al backend Laravel
        await axios.post('/contact-submit', form);
